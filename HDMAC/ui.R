  ...
  navbarPage("HD-MAC",
             ...
             tabPanel("Upload data",
                      ...
                      sidebarLayout(
                        ...
                        helpText("2. For those who want to use TCGA dataset, you can download it through Broad's FireBrowse portal website (http://firebrowse.org/), use R package TCGAlinks (a Bioconductor package) or use our R code (filename: Data Download From TCGA.R ; link: https://github.com/chung-R/HD-MAC).")
                        ),
